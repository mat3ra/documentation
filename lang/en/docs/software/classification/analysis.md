...
We enable support for several analysis (and visualization) tools. which are accessible primarily via our [Remote Desktop Environment]({{ interface_url }}/remote-connection/remote-desktop/) or [Command Line Interface]({{ interface_url }}/remote-connection/overview/). The tools are introduced [in this section]({{ guide_url }}/software-directory/overview/) of the documentation.
