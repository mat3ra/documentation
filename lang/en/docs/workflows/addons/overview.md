...
We allow for the insertion of **Add-ons** for performing certain specialized calculations, such as convergence studies. These can be added from either the [Header Menu]({{ guide_url }}/workflow-designer/header-menu/#inserting-add-ons) or the [Actions Menu]({{ guide_url }}/workflow-designer/subworkflow-editor/actions-menu/#insert-add-ons) of the [Workflow Designer Interface]({{ guide_url }}/workflow-designer/overview/).
