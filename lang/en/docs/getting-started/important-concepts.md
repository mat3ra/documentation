...
Our platform is designed to store and organize the **[simulation Data]({{ reference_url }}/data/classification/)** in centralized databases, under the conventions of **[Structured Representation]({{ reference_url }}/data-structured/convention/)**. A system of **[Queues]({{ dev_url }}/infrastructure/resource/queues/)** is in place for scheduling and tracking the allocation of **[computational Resources]({{ dev_url }}/infrastructure/resource/overview/)**, offered by the **[Clusters]({{ dev_url }}/infrastructure/clusters/overview/)** at the heart of our overall **[Infrastructure]({{ dev_url }}/infrastructure/overview/)**.
