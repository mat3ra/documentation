...
This set of initial and final structures together with images [ordered]({{ reference_url }}/entities-general/sets/) in a particular manner constitutes the interpolated set for the chemical reaction.
