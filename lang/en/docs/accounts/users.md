...
A User has to [switch to]({{ guide_url }}/accounts/ui/switcher/) one of (potentially) multiple distinct accounts which are available to him/her in order to perform any actions.
