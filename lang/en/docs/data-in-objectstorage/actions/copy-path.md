...
Upon its copying, this path can be conveniently used in the [Command Line Interface]({{ guide_url }}/cli/overview/) or [Remote Desktop](../../remote-connection/remote-desktop.md) environments for example.
