...
[Dropbox]({{ dev_url }}/data-in-objectstorage/dropbox/) has its own dedicated page within the Web Interface of our platform, which can be accessed via the [left-hand sidebar menu](../../ui/left-sidebar.md). The `Dropbox` option in this menu opens a file browser where one can navigate and edit files and directories.
