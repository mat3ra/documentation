...
An example of its appearance in the former context is portrayed in the image below, where it displays both the input and output files of the corresponding [Job simulation]({{ reference_url }}/jobs/overview/).
