...
3. 2018 Benchmarks for [VASP]({{ reference_url }}/software-directory/modeling/vasp/overview/) and [GROMACS]({{ reference_url }}/software-directory/modeling/gromacs/), are documented [here](2018-11-12-comparison.md).
