...
Similar to the "Application" settings section in the [Overview tab](subworkflow-editor/overview-tab.md) of the parent [Subworkflow Editor](subworkflow-editor/overview-tab.md), this section reviews the computational engine (otherwise known as [application]({{ guide_url }}/software-directory/overview/)) to be employed in the current unit. 
