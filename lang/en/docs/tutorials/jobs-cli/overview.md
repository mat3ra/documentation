...
[This first tutorial](job-cli-example.md) explains how to create the input scripts for running a materials science computation with the [Quantum ESPRESSO](../../software-directory/modeling/quantum-espresso/overview.md) modeling application. We also explain how to submit the corresponding [simulation job]({{ reference_url }}/jobs/overview/) to the [Resource Manager]({{ dev_url }}/infrastructure/resource/overview/) of our computational [infrastructure]({{ dev_url }}/infrastructure/overview/) via the [Command Line Interface](../../cli/overview.md).
