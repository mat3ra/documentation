...
This title may be relinquished to other users. In order to do that, a special [request]({{ guide_url }}/ui/support/) needs to be made to our support staff.
...
Members of both regular and administrative level are collectively referred to as the **People** of the Organization, which are listed under the corresponding [Explorer Interface]({{ guide_url }}/collaboration/ui/people-explorer/).
